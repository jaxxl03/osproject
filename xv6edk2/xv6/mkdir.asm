...
printint(int fd, int xx, int base, int sgn)
{
 ...
 429:	0f b6 91 d4 0a 00 00 	movzbl 0xad4(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 567:	75 25                	jne    58e <printf+0x103>
          s = "(null)";
 569:	c7 45 f4 85 08 00 00 	movl   $0x885,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 634:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 ...
 6ff:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 704:	90                   	nop
 705:	c9                   	leave  
 706:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 761:	83 c4 10             	add    $0x10,%esp
  return freep;
 764:	a1 f0 0a 00 00       	mov    0xaf0,%eax
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 781:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 784:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 789:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 790:	75 23                	jne    7b5 <malloc+0x4a>
    base.s.ptr = freep = prevp = &base;
 792:	c7 45 f0 e8 0a 00 00 	movl   $0xae8,-0x10(%ebp)
 799:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79c:	a3 f0 0a 00 00       	mov    %eax,0xaf0
 7a1:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 7a6:	a3 e8 0a 00 00       	mov    %eax,0xae8
    base.s.size = 0;
 7ab:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 7b2:	00 00 00 
  }
 ...
 808:	a3 f0 0a 00 00       	mov    %eax,0xaf0
      return (void*)(p + 1);
 ...
 813:	eb 3b                	jmp    850 <malloc+0xe5>
    ...
    if(p == freep)
 815:	a1 f0 0a 00 00       	mov    0xaf0,%eax
